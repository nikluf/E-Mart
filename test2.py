...
def usertable():
    ...
    if tutu==True:
        cur.execute("create table listofusers(userid int primary key, First_Name varchar(10),Last_Name varchar(10), gender char(1),pass varchar(20),email id varchar(40))")
        cur.execute("insert into listofusers values(1,'','','m','','abc town , 29 road......')")
        con.commit()
    cur.close()
    con.close()
...
def adminfullitview():
    ...
    for i in cur:
        ...
        print(120*'-')
        #print(f"{i[0]:<15}{gap}{i[1]:10}{gap}{i[2]:20}{gap}{i[3]:20}{gap}{i[4]:20}{gap}{i[5]:5}")
    print('\n','-'*156)
...
def ckiot():
    ...
    for i in cur:
        ...
        sumo+=(i[2]*i[3])
    print('-'*156,'\n')
    r=int(input("do you want to deliver to your given address"))
    cu
